...
func Test_isPrime(t *testing.T) {
	primeTests := []struct {
		...
		{"negative number", -11, false, "Negative Numbers are not prime!"},
	}
...
func Test_checkNumebers(t *testing.T) {
	tests := []struct {
		name     string
		input    string
		expected string
		...
		{name: "one", input: "1", expected: "1 is not a prime number, by definition!"},
